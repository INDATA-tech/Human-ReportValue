...
export default async ({ req, res, log, error }) => {
  ...
  var type = [
    {
      name: "Manifesting Generator", // bunu yazan programcı öldü, sen monoton bir rutin için doğmadın. -rip -od
