...
//----
  ...
  let guclu_yanlarin = (guclu_yanlarinData, age, type) => {
    if (guclu_yanlarinData.name == "10-57") {
      if (type == "10-57_1") {
        return guclu_yanlarin_10_57_1;
      } else if (type == "10-57_2") {
        return guclu_yanlarin_10_57_2;
      }
