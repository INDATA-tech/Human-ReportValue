...
export default async ({ req, res, log, error }) => {
  ...
  var P16A1 = teamwork(teamworkData[0].name, 25, "name"); // Ekip Çalımasına Yatkınlık Kendini Değerlendirme
  var P16A2 = teamwork(teamworkData[0].name, 25, "s3u1");
  var P16A3 = teamwork(teamworkData[1].name, 25, "name");
  var P16A4 = teamwork(teamworkData[1].name, 25, "s3u1");
  var P16A5 = teamwork(teamworkData[teamworkData.length - 1], 25, "name"); // Kendine sorabilirsin
  var P16A6 = teamwork(teamworkData[teamworkData.length - 1], 25, "s3u2");
  ...
  var P25A7 = worklearnstyle(worklearnData[0], 25, "s3_6");
  ...
  var P35A1 = decision_strategy(decision_strategyData[0], 25, "s4_x_title");
  var P35A2 = decision_strategy(decision_strategyData[0], 25, "s4_x_text");
  var P35A3 = "Adımlar";
  var P35A4 = decision_strategy(decision_strategyData[0], 25, "s4_x_1");
  var P35A5 = decision_strategy(decision_strategyData[0], 25, "s4_x_2");
  var P35A6 = decision_strategy(decision_strategyData[0], 25, "s4_x_3");
  var P35A7 = decision_strategy(decision_strategyData[0], 25, "s4_x_4");
  var P35A8 = decision_strategy(decision_strategyData[0], 25, "s4_x_5");
  var P35A6 = "image";
  var P36A1 = "image";
  ...
  var P37A3 = kariyer_secim(careerSelectionLastResult[1], 25, "s2_x_2");
  var P37A4 = kariyer_secim(careerSelectionLastResult[1], 25, "s2_x_2");
  var P37A5 = kariyer_secim(careerSelectionLastResult[2], 25, "s2_x_2");
  ...
  var P40A1 = kariyer_secim(careerSelectionLastResult, 25, "sector"); // Sana En uygun kariyer seçenekleri
  ...
  var inputs_25_plus = {
    P1A1:
      ...
      Object.entries(rawData).find(
        (x) => x.name == "kisiselbilgi / soyisim",
      )[1],
    P2A1:
      "Sevgili " +
      Object.entries(rawData).find((x) => x.name == "kisiselbilgi / isim")[1],
